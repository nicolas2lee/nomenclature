...
public class BatchConfiguration {
    ...
    @Bean
    public JdbcBatchItemWriter<Object> writer() {
        JdbcBatchItemWriter<Object> writer = new JdbcBatchItemWriter<Object>();
        writer.setItemSqlParameterSourceProvider(new BeanPropertyItemSqlParameterSourceProvider<Object>());
    ...
    public Job importUserJob(JobCompletionNotificationListener listener) {
        return jobBuilderFactory.get("importNomenclatureDataJob")
